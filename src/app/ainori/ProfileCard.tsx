import { Box, HStack, Avatar, Text, Icon, Image, VStack, Spacer } from "@chakra-ui/react";
...
const ProfileCard: React.FC<ProfileCardProps> = ({ name, date, time }) => (
    <Box borderWidth="1px" borderRadius="lg" overflow="hidden" p={5} bg="gray.100" width="100%">
        <VStack align="start" spacing={3} width="100%">
            ...
            <Text fontWeight="bold" ml={2}>学研北生駒まで</Text>
